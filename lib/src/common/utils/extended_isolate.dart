...
extension type ExtendedIsolate(Isolate isolate) implements Isolate {
  static final _expandoReceivePort = Expando<ReceivePort>('ExtendedIsolate[ReceivePort]');
  static final _expandoExternalSendPort = Expando<SendPort>('ExtendedIsolate[SendPort]');
  ...
  static Future<ExtendedIsolate> create(
    ...
    return ExtendedIsolate(rootIsolate);
  }
